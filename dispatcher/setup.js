module.exports = function (db) {
    ...
    db.serialize(function () {
        ...
        db.run('CREATE TABLE IF NOT EXISTS entries (id INTEGER PRIMARY KEY, feedId INTEGER NOT NULL, fetchid TEXT, url TEXT NOT NULL, normalizedUrl TEXT NOT NULL, title TEXT NOT NULL, author TEXT DEFAULT NULL, createdUtcSeconds FLOAT DEFAULT 0, body TEXT DEFAULT NULL, extras TEXT DEFAULT NULL, FOREIGN KEY(feedId) REFERENCES feeds(id) ON DELETE CASCADE)');
        ...
        db.run('CREATE TABLE IF NOT EXISTS filters (id INTEGER PRIMARY KEY, userId INTEGER NOT NULL, feedId INTEGER DEFAULT NULL, value TEXT, weight INTEGER DEFAULT 0, FOREIGN KEY(userId) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY(feedId) REFERENCES feeds(id) ON DELETE CASCADE)');
