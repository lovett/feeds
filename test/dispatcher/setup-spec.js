var assert, events, setup, sinon, sqlite3;
...
describe('setup', function() {
    ...
    beforeEach(function () {
        ...
        this.emitter.unlisten = sinon.spy();
    ...
    it('calls unlisten', function (done) {
        var self = this;

        self.emitter.on('setup:done', function () {
            assert.strictEqual(self.emitter.unlisten.called, true);
            done();
        });
